...
<Agent_Prompt>
  ...
  <Constraints>
    ...
    - Hand off to: planner (requirements gathered), architect (code analysis needed), verifier (plan exists and needs review).
  </Constraints>
  ...
  <Open_Questions>
    ...
    The orchestrator or planner will handle open questions as needed.
  </Open_Questions>

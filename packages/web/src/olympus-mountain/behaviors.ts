...
export const BEHAVIOR_MAP: Record<WorkerBehavior, BehaviorMapping> = {
  ...
  // Codex behaviors (4)
  supervising:   { zone: 'zeus_temple',    anim: 'stand',        altAnims: ['nod'],             bubble: null,          particle: null,        priority: 3 },
...
export function resolveZone(behavior: WorkerBehavior, sanctuaryZone: ZoneId): ZoneId {
  const mapping = BEHAVIOR_MAP[behavior];
  return mapping.zone === '_own_sanctuary' ? sanctuaryZone : mapping.zone;
}

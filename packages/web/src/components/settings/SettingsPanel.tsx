...
const THEMES: { id: ThemeName; label: string; emoji: string; desc: string; swatches: string[] }[] = [
  ...
  },
  {
    ...
    label: 'Solarized',
    emoji: '🌊',
    desc: 'Solarized Dark — teal bg, warm cream text',
  ...
  },
  {
    ...
    label: 'Autumn',
    emoji: '🍂',
    desc: 'Autumn amber — cozy dark brown & gold',
    swatches: ['#1a1005', '#f59e0b', '#fef3e2'],
  },
  {
    id: 'neon',
    label: 'Cyberpunk',
    emoji: '⚡',
    desc: 'Cyberpunk — electric blue & magenta',
    swatches: ['#020009', '#00d4ff', '#ff2d6f'],
  },
];

...
| **Worker Factory (V2)** | 3종 워커 (Claude CLI / Anthropic API SSE / tmux), 태스크별 자동 선택 |
| **Memory Store (V2)** | SQLite + FTS5 기반 작업 학습, 유사 태스크 조회, 패턴 매칭 |
...
3. **실행** (WorkerManager) — 3종 워커 중 자동 선택하여 실행
